$(document).ready(function () {
  ...
  function getNumberFieldHTML() {
      var field = generateField();
      var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Number </span><button type="button" class="toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></button><button type="button" class="mr-2 remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="number" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
      var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
  ...
  function getEmailFieldHTML() {
      var field = generateField();
      var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Email </span><button type="button" class="toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></button><button type="button" class="mr-2 remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="email" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
      var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
  ...
  function getPasswordFieldHTML() {
      var field = generateField();
      var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Password </span><button type="button" class="toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></button><button type="button" class="mr-2 remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="password" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
      var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
  ...
  function getTextAreaFieldHTML() {
      var field = generateField();
      var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Text Area </span><button type="button" class="toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></button><button type="button" class="mr-2 remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="textarea" data-field="' + field + '" style="background-color:#f2f2f2;"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
      var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
  ...
  function getPreview(plain_html = '') {
      ...
      el.each(function () {
          ...
          if (data_type === 'button') {
              ...
              html += '<div class="' + name + '"><button disabled style="margin-top:10px" name="" class="' + btn_class + ' ' + name + '">' + btn_value + '</button><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + btn_value + '"><input type="hidden" name="label[]" value="' + btn_class + '"><input type="hidden" name="type[]" value="button"></div>';
          }
          // if (data_type === 'select') {
          //     var option_html = '';
