$(document).ready(function () {
    ...
    function getButtonFieldHTML() {
        ...
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Button </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="button" data-field="' + field + '"><div class="form-group"><input type="text" name="class_' + field + '" class="form-control form_input_button_class" placeholder="Class" value="btn btn-primary" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="value_' + field + '" data-field="' + field + '" class="form-control form_input_button_value" value="Submit" placeholder="Value"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    
        // Add click event to toggle field visibility and change background color
        $fieldHtml.find('.toggle_field').on('click', function () {
            var field = $(this).data('field');
            var $formOutputContainer = $('.form_output_container[data-field="' + field + '"]');
            $formOutputContainer.toggle();
            if ($formOutputContainer.is(":visible")) {
                $formOutputContainer.find('.form_output').css('background-color', '#eee');
                $fieldHtml.css('height', '195px');
            } else {
                $formOutputContainer.find('.form_output').css('background-color', '#f2f2f2');
                $fieldHtml.css('height', '34.5px');
            }
        });
    ...
    function getTextFieldHTML() {
        var field = generateField();
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Text </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="text" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    ...
    function getNumberFieldHTML() {
        var field = generateField();
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Number </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="number" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    ...
    function getEmailFieldHTML() {
        var field = generateField();
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Email </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="email" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    ...
    function getPasswordFieldHTML() {
        var field = generateField();
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Password </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="password" data-field="' + field + '"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    ...
    function getDateFieldHTML() {
        var field = generateField();
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Date </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="date" data-field="' + field + '" style="background-color:#f2f2f2;"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    ...
    function getTextAreaFieldHTML() {
        var field = generateField();
        var html = '<div class="all_div"><div class="row li_row"><div class="col-md-12"><span>Text Area </span><a type="button" class="btn btn-secondary btn-sm toggle_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></a><button type="button" class="mr-2 btn btn-danger btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button></div></div></div><hr/><div class="row li_row form_output_container" data-field="' + field + '" style="display: none;"><div class="col-md-12 form_output" data-type="textarea" data-field="' + field + '" style="background-color:#f2f2f2;"><div class="form-group"><input type="text" name="label_' + field + '" class="form-control form_input_label" value="Label" data-field="' + field + '"/></div><div class="form-group"><input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/></div><div class="form-group"><input type="text" name="text_' + field + '" class="form-control form_input_name" value="col-md-12"/></div><div class="form-check"><label class="form-check-label"><input data-field="' + field + '" type="checkbox" class="form-check-input form_input_req">Required</label></div></div></div>';
        var $fieldHtml = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
    ...
    function getPreview(plain_html = '') {
        ...
        el.each(function () {
            ...
            if (data_type === 'text') {
                ...
                html += '<div class="' + name + '"><label class="control-label">' + label + '</label><input type="text" name="content[]" placeholder="' + placeholder + '" class="form-control" ' + required + '/><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + placeholder + '"><input type="hidden" name="label[]" value="' + label + '"><input type="hidden" name="required[]" value="' + required + '"><input type="hidden" name="type[]" value="text"></div>';
            }
            if (data_type === 'number') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="' + name + '"><label class="control-label">' + label + '</label><input type="number" name="content[]" placeholder="' + placeholder + '" class="form-control" ' + required + '/><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + placeholder + '"><input type="hidden" name="label[]" value="' + label + '"><input type="hidden" name="required[]" value="' + required + '"><input type="hidden" name="type[]" value="number"></div>';
            }
            if (data_type === 'email') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="' + name + '"><label class="control-label">' + label + '</label><input type="email" name="content[]" placeholder="' + placeholder + '" class="form-control" ' + required + '/><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + placeholder + '"><input type="hidden" name="label[]" value="' + label + '"><input type="hidden" name="required[]" value="' + required + '"><input type="hidden" name="type[]" value="email"></div>';
            }
            if (data_type === 'password') {
                ...
                html += '<div class="' + name + '"><label class="control-label">' + label + '</label><input type="password" name="content[]" placeholder="' + placeholder + '" class="form-control" ' + required + '/><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + placeholder + '"><input type="hidden" name="label[]" value="' + label + '"><input type="hidden" name="required[]" value="' + required + '"><input type="hidden" name="type[]" value="password"></div>';
            }
            if (data_type === 'textarea') {
                ...
                html += '<div class="' + name + '"><label class="control-label">' + label + '</label><textarea rows="1" name="content[]" placeholder="' + placeholder + '" class="form-control" ' + required + '/><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + placeholder + '"><input type="hidden" name="label[]" value="' + label + '"><input type="hidden" name="required[]" value="' + required + '"><input type="hidden" name="type[]" value="textarea"></div>';
            }
            if (data_type === 'date') {
                var checkbox = $(this).find('.form-check-input');
                var required = '';
                ...
                html += '<div class="' + name + '"><label class="control-label">' + label + '</label><input type="date" name="content[]" class="form-control" ' + required + '/><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="label[]" value="' + label + '"><input type="hidden" name="required[]" value="' + required + '"><input type="hidden" name="type[]" value="date"></div>';
            }
            if (data_type === 'button') {
                var btn_class = $(this).find('.form_input_button_class').val();
                var btn_value = $(this).find('.form_input_button_value').val();
                html += '<button disabled style="margin-top:10px" name="" class="' + btn_class + ' ' + name + '">' + btn_value + '</button><input type="hidden" name="class[]" value="' + name + '"><input type="hidden" name="placeholder[]" value="' + btn_value + '"><input type="hidden" name="type[]" value="button">';
            }
            // if (data_type === 'select') {
            //     var option_html = '';
